...
histogram will contain some blank spaces that will result in "black holes" in
the final sonar image. To avoid this precision limitation, we store the
...
% \todo[inline, color=red!40]{Rômulo's answer}
\textbf{This sentence has been rewritten in our revised manuscript.}
...
bearings. We took this point and revised the text to make it clearer by
...
% \todo[inline, color=red!40]{Rômulo's answer}
\textbf{This paper have followed the journal's LaTeX template.}
