...
% \todo[inline, color=green!40]{Jan's answer}
\textbf{Thank you for catching this points. We have rewritten the sentences
...
pipeline on GPU to compute the acoustic frame instead of simulating ray paths and
the effect of theirs encounters with the virtual objects. Computing the multipath
reflection in sonar simulation is computationally costly, thus we need to consider
the computation time again by modeling and including phenomena such as reverberation.}
