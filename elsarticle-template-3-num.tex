...
%%%Imporância da simulação para roôs autônomos
...
%Reescrever seguindo o padrão: OLD INFO.... NEW INFO, para cada sentença e parágrafo
%%AUV
...
%%%Sensoriamento com sonares... aqui vai falar sobre os tipos
...
\begin{figure*}[!h]
    ...
    \captionsetup{justification=centering}
    \caption{Forward-looking sonar simulation experiments: \subref{fig:fls_scene1}, \subref{fig:fls_scene2} and \subref{fig:fls_scene3} present the trials of underwater, while \subref{fig:fls_sim1}, \subref{fig:fls_sim2} and \subref{fig:fls_sim3} are the following acoustic representations of each scenario, respectively.}
    \label{fig:fls}
\end{figure*}
