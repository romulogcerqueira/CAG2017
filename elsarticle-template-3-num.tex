...
\begin{figure*}[!ht]
    ...
    \captionsetup{justification=centering}
    \caption{Mechanical scanning imaging sonar experiments: the underwater scenes presented \subref{fig:msis_scene1}, \subref{fig:msis_scene2} and \subref{fig:msis_scene3}, and the respective simulated frames in \subref{fig:msis_sim1}, \subref{fig:msis_sim2} and \subref{fig:msis_sim3}.}
    \label{fig:msis}
\end{figure*}
