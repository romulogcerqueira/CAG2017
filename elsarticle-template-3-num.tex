...
% Acredito que isto seja uma afirmação muito forte a ser feita, mesmo com referência
...
In this work, the underwater scene is sampled by a virtual camera, whose optical axis is aligned with the intended viewing direction of the imaging sonar, even as the range and opening angle. By programming the fragment and vertex shaders, the sonar data is computed as:
...
\begin{figure*}[!h]
    \centering
    \subfigure[][]{
        \includegraphics[width=0.42\paperwidth,height=5cm]{figs/fls_scene1}
        \label{fig:fls_scene1}
    }
    \subfigure[][]{
        \includegraphics[width=0.42\paperwidth,height=5cm]{figs/fls_sim1}
        \label{fig:fls_sim1}
    }
    \subfigure[][]{
        \includegraphics[width=0.42\paperwidth,height=5cm]{figs/fls_scene2}
        \label{fig:fls_scene2}
    }
    \subfigure[][]{
        \includegraphics[width=0.42\paperwidth,height=5cm]{figs/fls_sim2}
        \label{fig:fls_sim2}
    }
    \subfigure[][]{
        \includegraphics[width=0.42\paperwidth,height=5cm]{figs/fls_scene3}
        \label{fig:fls_scene3}
    }
    \subfigure[][]{
        \includegraphics[width=0.42\paperwidth,height=5cm]{figs/fls_sim3}
        \label{fig:fls_sim3}
    }
    \captionsetup{justification=centering}
...
\begin{figure*}[!h]
    \centering
    \subfigure[][]{
        \includegraphics[width=0.42\paperwidth,height=5cm]{figs/msis_scene1}
        \label{fig:msis_scene1}
    }
    \subfigure[][]{
        \includegraphics[width=0.42\paperwidth,height=5cm]{figs/msis_sim1}
        \label{fig:msis_sim1}
    }
    \subfigure[][]{
        \includegraphics[width=0.42\paperwidth,height=5cm]{figs/msis_scene2}
        \label{fig:msis_scene2}
    }
    \subfigure[][]{
        \includegraphics[width=0.42\paperwidth,height=5cm]{figs/msis_sim2}
        \label{fig:msis_sim2}
    }
    \subfigure[][]{
        \includegraphics[width=0.42\paperwidth,height=5cm]{figs/msis_scene3}
        \label{fig:msis_scene3}
    }
    \subfigure[][]{
        \includegraphics[width=0.42\paperwidth,height=5cm]{figs/msis_sim3}
        \label{fig:msis_sim3}
    }
    \captionsetup{justification=centering}
