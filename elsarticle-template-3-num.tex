...
% Rewrite this sentence, according the reviewers' comments:
% As opposed to
...
All those three informations are 2D and normalized into the interval [0,1],
...
$\rho$ is passed to the fragment shader and processed on GPU. So the final
...
The 3-channel shader matrix is processed in order to build the corresponding
...
to behave a Gaussian random variable \cite{papoulis2002}. A Gaussian distribution is defined
...
The simulator is available as open source on github under the \emph{Brazilian
Institut of Robotics} organisation:
https://github.com/Brazilian-Institute-of-Robotics/simulation-gpu_sonar_simulation
