...
This paper presents an imaging sonar simulator which manipulates the rendering pipeline to compute a sonar image with a low computation cost.
...
In addition to our previous work \cite{cerqueira2016}, the normal data can also be defined by bump mapping technique and material's reflectivity. The speckle noise is modeled as a non-uniform Gaussian distribution and added to sonar image.
