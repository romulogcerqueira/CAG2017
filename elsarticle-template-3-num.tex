...
\begin{figure*}[ht]
    ...
    \captionsetup{justification=centering}
    \caption{Forward-looking sonar simulation experiments: Figs. \subref{fig:fls_scene1} and \subref{fig:fls_scene2} presents the trials underwater scenarios and Figs. \subref{fig:fls_sim1} and \subref{fig:fls_sim2} are the following acoustic representations, respectively.}
    \label{fig:fls}
\end{figure*}
...
\begin{figure*}[ht]
    ...
    \captionsetup{justification=centering}
    \caption{Mechanical Scanning Imaging Sonar trials: the underwater scenes represented in Figs. \subref{fig:msis_scene1} and \subref{fig:msis_scene2} and their following simulated frames in Figs. \subref{fig:msis_sim2} and \subref{fig:msis_sim2}.}
    \label{fig:msis}
\end{figure*}
