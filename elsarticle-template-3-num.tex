...
% Simulation for AUVs (this paragraph should be rewritten)
...
This paper introduces an imaging sonar simulation method can overcome the main limitations of existing approaches. As opposed to \cite{bell1997,waite2002,sac2015,demarco2015,gu2013,kwak2015}, the same model here is able to reproduce two different kind of sonar devices. Also, the intensity measured back from the objects in underwater scene depends of accumulated energy based on surface normal directions, instead of statically defined by the user \cite{demarco2015} or binary representation \cite{gu2013, kwak2015}. 

% mesmo modelo pode reproduzir diferentes tipos de sonars
% aceleração por customização da GPU
% adição de ruído multiplicativo
% bump mapping
% material properties
% intensidade dos materiais
% real-time
