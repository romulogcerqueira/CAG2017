...
\begin{figure*}[!ht]
    ...
    \captionsetup{justification=justified}
    \caption{\textcolor{blue}{Real-world sonar images and the virtual images generated by our approach, with the same device configurations: SSIV taken with Tritech Gemini 720i \subref{fig:eval:ssiv:real} and the corresponding simulated FLS image \subref{fig:eval:ssiv:sim}; tank walls taken with Tritech Micron DST \subref{fig:eval:tank:real} and the corresponding simulated MSIS representation \subref{fig:eval:tank:sim}.}}
    \label{fig:eval}
\end{figure*}
