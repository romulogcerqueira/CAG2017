...
%%Luciano 28/05/2017: Essa parte em azul está estranha, pois entra em detalhes sobre uma questão que nunca disse antes. O objetivo do artigo é apenas falar sobre o simulador e não a integração com o robô real. Devemos nos ater a apenas a contribuição que estamos sugerindo. Sugiro mudar o contexto desta parte para o potencial do simulador em se ligar a um robô real, etc. Outra questão importante: vc tem um costume muito forte de usar "it", this, etc, ou seja pronomes que se referem a objetos que citou anteriormente. Essa é uma prática de escrita que diminui a compreensão do que escreve. Sugiro reescrever a parte do texto abaixo que tem isso.
...
%%%Luciano 28/05/2017: Não vejo sentido desta frase tão básica no artigo. tiraria.
%\textcolor{blue}{GPUs are parallel numeric computing chips specialized to speed up 2D and 3D graphics processing, reducing the computational effort of the central processing unit (CPU).} 
%%%Luciano 28/05/2017: esse parágrafo abaixo não está em azul mas parece que foi acrescido. Tem informações didáticas sobre shaders, vertexs, etc. Alguém pediu isso? É novo? Não vejo sentido em explicar isso para um público que é de CG...
...
\begin{itemize}[]
%%%Luciano 28/05/2017: Acho que discutimos mais sobre esta questão da limitação. Não sei se o verbo usar é o mais adequado na hora de dizer que armazenou o depth no depth buffer. Além disso, não discute nada sobre os outros parâmetros.
...
%%%Luciano 28/05: Tirei aqui o que estava em azul
%%% Pareceu-me que mudou algumas coisas no parágrafo abaixo. Achei que ficou ruim. Por exemplo: portray - retrata. Não é um verbo que se usa para representar valores. Cuidado com o que muda, para não cair em traduções mal feitas.
